...
def detail(goal_id):
    ...
    return render_template('goal/goal_detail.html', goal=goal)
...
def done(goal_id):
    ...
    goal.done = True
    db.session.commit()
    return redirect(url_for('goal.list', goal_id=goal_id))
...
def modify(goal_id):
    ...
    return render_template('goal/goal_form.html', form=form, goal=goal)
